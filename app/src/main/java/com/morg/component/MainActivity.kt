...
fun Greeting(modifier: Modifier = Modifier) {
    Column(
        ...
        TextFieldComponent(componentSize = ComponentSize.SMALL)
        Spacer(modifier = Modifier.height(5.dp))
        TextFieldComponent(componentSize = ComponentSize.MEDIUM)
        Spacer(modifier = Modifier.height(5.dp))
        TextFieldComponent(componentSize = ComponentSize.LARGE)
        Spacer(modifier = Modifier.height(5.dp))
